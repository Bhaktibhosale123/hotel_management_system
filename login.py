...
class login_window:
     def __init__(self,root):
         ...
         i1=Image.open(r"C:\Users\bhakt\Downloads\hotel images\login.jpg")
         ...
         i2=Image.open(r"C:\Users\bhakt\Downloads\hotel images\login.jpg")
         ...
         i3=Image.open(r"C:\Users\bhakt\Downloads\hotel images\lock.jpg")
         ...
         if (self.txt_email.get()=="" or self.txt_pass.get()==""):
             ...
             if result==None:
                messagebox.showerror("Error","Invalid username and password")
                 ...
                 if open_main>0:
                     self.new_window=Toplevel(self.root)
                     self.app=Hotel_Management(new_window)
                 else:
                     if not open_main:
                         return
             conn.commit()
     ...
     def forgot_password_window(self):
         if self.txt_email.get()=="":
             ...
             if result==None:
                messagebox.showerror("Error","Pkease enter valid username")
             else:
                conn.close()
...
class register:
     def __init__(self,root):
         ...
         i1=Image.open(r"C:\Users\bhakt\Downloads\hotel images\register-removebg-preview.png")
